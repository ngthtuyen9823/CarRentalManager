...
insert into [dbo].[Contract] values(1,1,1, 'COMPLETE', 10100, 10100, 0, '', 'INTACT','', '2019-01-01', '2019-01-03')
...
insert into [dbo].[Contract] values(4,4,1, 'COMPLETE', 4888, 4888, 0, '', 'INTACT','', '2019-03-20', '2019-03-20')
...
insert into [dbo].[Contract] values(20,20,1, 'COMPLETE', 900, 900, 0, 'The car is so old', 'INTACT','', '2020-01-20', '2020-01-20')
...
insert into [dbo].[Contract] values(31,33,1, 'COMPLETE', 5000, 5000, 0, 'This service is so good', 'INTACT','', '2021-01-20', '2021-01-20')
...
insert into [dbo].[Contract] values(37,39,1, 'COMPLETE', 4154, 4154, 0, '', 'INTACT','', '2021-04-20', '2021-04-20')
...
insert into [dbo].[Contract] values(42,49,4, 'UNPAID', 1425, 200, 1225, 'Xe hoi cu', 'INTACT','', '2022-07-20', '2022-07-20')
...
insert into [dbo].[Contract] values(45,54,1, 'UNPAID', 10100, 200, 9900, '', 'INTACT','', '2023-01-01', '2023-01-03')
insert into [dbo].[Contract] values(46,56,1, 'UNPAID', 3567, 200, 3167, '', 'INTACT','', '2023-03-20', '2023-03-20')
insert into [dbo].[Contract] values(47,57,1, 'UNPAID', 4534, 200, 4234, '', 'INTACT','', '2023-03-20', '2023-03-20')
